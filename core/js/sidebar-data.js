const LEFT_TAGS_HTML = `
        <div class="side-widget fade-up">
            <ul class="side-widget-list">
                 <li><a href="/pages/toanhoc.html?filter=vmo">VMO <span>58</span></a></li>
                ...
                <li><a href="/pages/toanhoc.html?filter=tools">Tool <span>4</span></a></li>
            </ul>
            ...
            <ul class="side-widget-list">
                ...
                <li><a href="/pages/saved.html">★ Saved</a></li>
            </ul>
        </div>
`;
